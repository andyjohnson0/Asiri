...
namespace uk.andyjohnson.Asiri.ContainerBrowser
{
    ...
    public partial class CredentialsDialog : Window
    {
        ...
        public CredentialsDialog()
        {
            ...
            var algorithmOptions = new List<AlgorithmOption<CryptoAlgorithm>> { new("Unspecified", null) };
            ...
            var hashAlgorithmOptions = new List<AlgorithmOption<HashAlgorithm>> { new("Unspecified", null) };
